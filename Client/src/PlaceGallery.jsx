...
export default function PlaceGallery({place}){
  ...
  if (showAllPhotos) {
        ...
        <div className="bg-black p-8 grid gap-4">
          <div>
            ...
            <button
              ...
              className="fixed right-12 top-8 flex gap-1 px-2 py-2 rounded-2xl shadow shadow-black bg-white text-black"
            >
              <svg
    ...
    return(
        ...
        <div className="grid gap-2 border border-black lg:grid-cols-[2fr_1fr] grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
